...
#define EBRAKE_OVERRIDE_REAR 0x0000000000000002
#define EBRAKE_OVERRIDE_ALL (EBRAKE_OVERRIDE_FRONT) | (EBRAKE_OVERRIDE_REAR)

#define EBRAKE_OVERRIDE_LIST                                                   \
  { (EBRAKE_OVERRIDE_FRONT), (EBRAKE_OVERRIDE_REAR) }
